...
(Contributor License Agreement)Terms under which a contributor grants a license to an open source project for their contributions.
...
May refer to: [Application Developer](#application-developer), [Code Contributor](#code-contributor), or [Platform Developer](#platform-developer). <!-- @todo: link -->
